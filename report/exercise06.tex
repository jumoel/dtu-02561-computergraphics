...
Formålet med denne ugeopgave var at blive bekendt med OpenGL's
...
Scenen, tegnet med OpenGL's normale \emph{pipeline} kan ses på figur
\ref{fig:6-1}. I programmet blev linjen, der aktiverede
\emph{shaderne} udkommenteret, hvormed OpenGL selv sørgede for
...
Vha. de følgende to shaderprogrammer, blev Gouraud-shading
...
Resultatet kan ses på figur \ref{fig:6-2}.
...
Det blev gjort vha. følgende to shaderprogrammer:
...
Resultatet kan ses på figur \ref{fig:6-3}.
...
Teksturen på tekanden, der kan ses på figur \ref{fig:6-4}, blev påsat
ved hjælp af følgende tilføjelser i shaderprogrammerne:

\begin{verbatim}
// Tilføjelse i vertexshaderen
