...
namespace Graphics
{
	...
	public:
		...
		TrackBall(const CGLA::Vec3f&, float, float, unsigned, unsigned);
...
// 		void set_eye_dir(const CGLA::Vec3f&);
...
// 		}
		...
		/// Call to reset the trackball and bring everything home to square one.
		void reset();
