/*
 * These Root solvers are really a graphics gem, since I am devoted to
 * non reinvention of excellent wheels. I did however touch up the code
 * slightly to make it more suitable for a c++ framework. (Andreas)
 *
 *  Roots3And4.c
 *
 ...
 *  Oct 11, 1990    Fixed sign problem for negative q's in solve_quartic
