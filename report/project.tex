...
zoomet ud (se afsnit \ref{sec:zoom} under ``Zoom'') eller er mange objekter i
...
\texttt{circuit.ccd}-fil i programmets mappe kan denne hentes ind ved
...
panorering samt størrelse. Man kan åbne \texttt{circuit.ccd}-filen ved
at bruge højrekliksmenuen.
...
gemte filer (se afsnit \ref{sec:gemning-af-filer} under ``Gemning og
indlæsning af filer''). Endvidere er det muligt, manuelt at indlæse den
automatisk gemte fil ved hjælp af højrekliksmenuen.
...
slutpunkt, og det dermed kun er den ene ende der skal flyttes.
