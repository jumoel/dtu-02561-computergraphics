...
er parallel med viewplanet. \todo{omformuler (og oversæt?), så det er
  mere klart}
...
x-aksen samt under kameraet, mens en forstørreæse af \emph{fov} ville
...
\caption{Frontperspektiv (sidestørrelse: 2)}
\label{fig:1-8-2}
\end{figure}
