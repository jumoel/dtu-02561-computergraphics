...
Vi har lavet et program der tegner et rødt polygon og kaster en skygge i XwZw planet som kan ses på figur \ref{fig:7-1-1}.

\begin{figure}[hp]
\centering
\includegraphics[width=8cm]{../exercise7/screenshots/1a.png}
\caption{Skygge i XwZw}
\label{fig:7-1-1}
\end{figure}

Dernæst skulle skyggen flyttes ned i Yw=-4.
Vores løsning flytter blot kassen og lyset 4 højere efter skyggen er tegnet da dette virkede som en lettere løsning. Det kan ses af figur \ref{fig:7-1-2}.
...
Vi kunne tegne kassen med \texttt{glutSolidCube}, men har istedet valgt manuelt at lave alle koordinaterne til vertexerne for at prøve det.

Kassen kan ses på figur \ref{fig:7-2-1} med dens tilhørende skygge i YwZw planet hvor Xw=-4.
...
Til opgave 3 skal der tilføjes ``directional light'' til de 2 foregående opgaver. Det gøres ved at lave matricen $\mathbf{M}$ om til at inkludere planet hvilket bla. ses i opgave 5.17.
...
\caption{Directional light på kassen}
\label{fig:7-3-3}
\end{figure}
