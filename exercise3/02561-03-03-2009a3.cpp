...
void display(void)
{
   ...
   glPushMatrix ();
   glRotated ((GLdouble) (spinLight/10), 1.0, 0.0, 0.0);
   ...
   glPushMatrix ();
   glRotated ((GLdouble) (spinObj/10), 0.0, 1.0, 0.0);
...
void idle (void)
{
	spinLight = (spinLight + 2)%3600;
	spinObj = (spinObj + 1) % 3600;
	glutPostRedisplay();
}
